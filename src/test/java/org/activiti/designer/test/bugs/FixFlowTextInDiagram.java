...
public class FixFlowTextInDiagram {
    ...
    @Test
    @org.activiti.engine.test.Deployment(resources = { "diagrams/bugs/leave.bpmn" })
    public void startProcess1111() throws Exception {
        RepositoryService repositoryService = activitiRule.getRepositoryService();
        repositoryService.createDeployment().addInputStream("aaa.bpmn20.xml", new FileInputStream("/Users/henryyan/work/projects/activiti/activiti-study/src/test/resources/diagrams/bugs/leave.bpmn")).deploy();
