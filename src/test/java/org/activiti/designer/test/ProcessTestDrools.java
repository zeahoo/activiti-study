...
public class ProcessTestDrools {
    ...
    public void startProcess() throws Exception {
        ...
        repositoryService.createDeployment().addInputStream("drools.bpmn20.xml", new FileInputStream(filename)).addInputStream("hello.drl", new FileInputStream(ruleFile)).deploy();
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("drools", variableMap);
        assertNotNull(processInstance.getId());
        System.out.println("id " + processInstance.getId() + " " + processInstance.getProcessDefinitionId());

        /*
         * // 从运行中查询 Object variable = runtimeService.getVariable(processInstance.getId(), "rulesOutput"); assertNotNull(variable); List<Object> varList = (List<Object>) variable; assertEquals(1,
         * varList.size()); Message ruledMessage = (Message) varList.get(0); assertEquals(1, ruledMessage.getStatus());
         */
        ...
        for (HistoricDetail historicDetail : list) {
            ...
            System.out.println(variableDetail.getVariableName() + " = " + variableDetail.getValue());
